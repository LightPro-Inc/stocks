...
public class OperationTypeMetadata implements DomainMetadata {
	...
	public String preparationOpTypeIdKey(){
		return "preparation_optypeid";
	}
	
	public String returnOpTypeIdKey(){
		return "return_optypeid";
	}
	
	public static OperationTypeMetadata create(){
