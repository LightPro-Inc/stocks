		...
		return createHttpResponse(
				new Callable<Response>(){
					...
					public Response call() throws IOException {
						...
						log.info(String.format("Création de l'article %s", cmd.name())); 						
		...
		return createHttpResponse(
				new Callable<Response>(){
					...
					public Response call() throws IOException {
						...
						log.info(String.format("Mise à jour des données de plannification de l'article %s", article.name()));
						return Response.status(Response.Status.OK).build();
					}
				});		
	}
		...
		return createHttpResponse(
				new Callable<Response>(){
					...
					public Response call() throws IOException {
						...
						log.info(String.format("Mise à jour à des données de l'article %s", cmd.name()));
						return Response.status(Response.Status.OK).build();
					}
				});		
	}
